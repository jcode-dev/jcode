$(function() {
  ...
  function changeContentsClose() {
    $('#modal-open').removeClass('is-active');
  ...
  Code.bindClick('linkButton', changeContents);
  ...
  var loginPage = '#linkButton'; // The login page
  var chatPage = '#loginOk'; // The chatroom page
  ...
  function addParticipantsMessage (data) {
    ...
    if (data.numUsers === 1) {
      ...
      message += "いまは、 " + data.numUsers + " 人さんかしてます。";
    }
    log(message);
  }
